...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || TAR UMT SHOP</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['username'])) {
            echo '<a href="payment.php"><button style="float:right;">Check Out</button></a>';
          }
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; 2024 TAR UMT Shop. All Rights Reserved.</p>
        </footer>
